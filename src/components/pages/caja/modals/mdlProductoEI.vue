            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <div>
                    <el-table ref="listado" :data="lobeListadoFiltrado" 
                        ...
                        <el-table-column prop="Stock" width="70">
                            <template slot="header" slot-scope="scope">
                                <span class="textAdjust textcenter">Stock</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="desTipo" width="75">
                            <template slot="header" slot-scope="scope">
                                <span class="textAdjust textcenter">Tipo</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="DesProdLaboratorio" width="115">
                            <template slot="header" slot-scope="scope">
                                <span class="textAdjust textcenter">Laboratorio</span>
                            </template>
                        </el-table-column>
                        <el-table-column prop="DesProdTipoPresentacion" width="120">
                            <template slot="header" slot-scope="scope">
                                <span class="textAdjust textcenter">Presentación</span>
                            </template>
                        </el-table-column>
                    </el-table>
                    <el-pagination
...
export default {
    name: "app",
    props: ['isModal','busqueda','idTienda'],
    components: { 
      //HeaderPage
    },
    data() {
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          CajaService.CargarProductosCaja(this.usuario.usuarioLogin,this.usuario.idCliente, this.idTienda, this.busqueda)
            .then(res => {
                if (res.status==200){
