...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Nota de Crédito',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE NOTA DE CRÉDITO - POR DIA";
                ...
                this.tittleReporte="REPORTE DE NOTA DE CRÉDITO - POR MES";
                ...
                this.tittleReporte="REPORTE DE NOTA DE CRÉDITO - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE NOTA DE CRÉDITO - POR RANGO";
            ...
            ReporteFacturacionService.ReporteNotaCredito(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
