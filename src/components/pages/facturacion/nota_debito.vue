...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Nota de Débito',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE NOTA DE DÉBITO - POR DIA";
                ...
                this.tittleReporte="REPORTE DE NOTA DE DÉBITO - POR MES";
                ...
                this.tittleReporte="REPORTE DE NOTA DE DÉBITO - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE NOTA DE DÉBITO - POR RANGO";
            ...
            ReporteFacturacionService.ReporteNotaDebito(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
