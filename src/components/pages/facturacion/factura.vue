...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Facturas',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE FACTURAS - POR DIA";
                ...
                this.tittleReporte="REPORTE DE FACTURAS - POR MES";
                ...
                this.tittleReporte="REPORTE DE FACTURAS - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE FACTURAS - POR RANGO";
            ...
            ReporteFacturacionService.ReporteFactura(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
