...
export default {
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE RESUMEN DIARIO - POR DIA";
                ...
                this.tittleReporte="REPORTE DE RESUMEN DIARIO - POR MES";
                ...
                this.tittleReporte="REPORTE DE RESUMEN DIARIO - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE RESUMEN DIARIO - POR RANGO";
            ...
            ReporteFacturacionService.ReporteResumenDiario(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
