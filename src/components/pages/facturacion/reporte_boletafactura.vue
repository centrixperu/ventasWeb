...
import ReporteFacturacionService from '@/services/facturacion/facturacion-service'
...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Venta por Tipo de Documento',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        CargarTipoComprobante(){
          ...
          ReporteFacturacionService.CargarComprobanteTienda(this.usuario.usuarioLogin, this.usuario.idCliente, this.IdTienda)
            .then(res => {
                loading.close();
                if (res.status==200){
                    this.lobeTipoDocumento = res.result;
                } else if (res.status==300){
                    this.$message({
                        showClose: true,
                        message: res.result,
        ...
        ValidarGuardar(){
            ...
            if(this.IdTipoDocumento==0){
                return 'Debe seleccionar Tipo de Comprobante.';
            }
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE VENTA POR COMPROBANTE - POR DIA";
                ...
                this.tittleReporte="REPORTE DE VENTA POR COMPROBANTE - POR MES";
                ...
                this.tittleReporte="REPORTE DE VENTA POR COMPROBANTE - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE VENTA POR COMPROBANTE - POR RANGO";
            ...
            ReporteFacturacionService.ReporteComprobante(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
                                        this.isMes, this.isAnio, this.isRango, fechainicio, fechafin, 
                                        this.IdTienda, desTienda, this.IdTipoDocumento)
                .then(res => {
                    loading.close();
                    if (res.status==200){
