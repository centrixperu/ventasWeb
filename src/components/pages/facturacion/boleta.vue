...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Boletas',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE BOLETAS - POR DIA";
                ...
                this.tittleReporte="REPORTE DE BOLETAS - POR MES";
                ...
                this.tittleReporte="REPORTE DE BOLETAS - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE BOLETAS - POR RANGO";
            ...
            ReporteFacturacionService.ReporteBoleta(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
