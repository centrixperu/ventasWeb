...
export default {
    ...
    data() {
        return {
            tittleModulo:'Registro de Comunicación de Baja',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE COMUNICACION DE BAJA - POR DIA";
                ...
                this.tittleReporte="REPORTE DE COMUNICACION DE BAJA - POR MES";
                ...
                this.tittleReporte="REPORTE DE COMUNICACION DE BAJA - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE COMUNICACION DE BAJA - POR RANGO";
            ...
            ReporteFacturacionService.ReporteComunicacionBaja(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
