...
export default {
    ...
    data() {
        return {
            ...
            isSubTitleModal:'',
            lobeModal:[],
            tittleModulo:'Ver Guías x Tienda',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE GUIAS POR TIENDA - POR DIA";
                ...
                this.tittleReporte="REPORTE DE GUIAS POR TIENDA - POR MES";
                ...
                this.tittleReporte="REPORTE DE GUIAS POR TIENDA - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE GUIAS POR TIENDA - POR RANGO";
