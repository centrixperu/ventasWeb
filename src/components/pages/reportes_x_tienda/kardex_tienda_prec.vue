...
export default {
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE KARDEX DE TIENDA POR PRECIO - POR DIA";
                ...
                this.tittleReporte="REPORTE DE KARDEX DE TIENDA POR PRECIO - POR MES";
                ...
                this.tittleReporte="REPORTE DE KARDEX DE TIENDA POR PRECIO - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE KARDEX DE TIENDA POR PRECIO - POR RANGO";
