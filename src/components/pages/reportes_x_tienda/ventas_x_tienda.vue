...
export default {
    ...
    data() {
        return {
            tittleModulo:'Kardex Tienda por Precio',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA - POR DIA";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA - POR MES";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA - POR RANGO";
            ...
            ReporteClienteTiendaService.RegistroVentas(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
