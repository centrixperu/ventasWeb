...
export default {
    ...
    data() {
        return {
            tittleModulo:'Ventas de Tienda por Producto',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA POR PRODUCTO - POR DIA";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA POR PRODUCTO - POR MES";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA POR PRODUCTO - POR AÑO";
                ...
                this.tittleReporte="REPORTE DE VENTAS DE TIENDA POR PRODUCTO - POR RANGO";
