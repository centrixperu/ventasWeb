                    ...
                    <div class="cus-container-border margin0 width100">
                        <el-main class="padding5">
                            ...
                            <el-row :gutter="5" type="flex" class="paddingTop10">
                                <el-col :xs="7" :sm="6" :md="4" :lg="3" :xl="1">
                                    <div class="cus-label-form-left">
                                        <span class="cus-label textAdjust textAlignL">Grupo Médico:</span>
                                    </div>
                                </el-col>
                                <el-col :xs="17" :sm="18" :md="20" :lg="19" :xl="20">
                                    <div>
                                        <el-input type="text" id="codigo"
                                            ...
                                            placeholder="Nombre Grupo Médico" 
                                            v-model="grupomedico"
                                            show-word-limit
                                            maxlength="150">
                                        </el-input>
                        ...
                        <div>
                            <el-table ref="listado" :data="lobeListadoFiltrado" 
                                ...
                                <el-table-column prop="Nombre" 
                                        width="350">
                                    <template slot="header" slot-scope="scope">
                                        <span class="textAdjust textcenter">Grupo Médico</span>
                                        <span class="caret-wrapper">
                                        ...
                                        <el-input size="mini" class="padding0" 
                                                v-model="grupomedicoTable"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column
                                        width="100">
                        ...
                        <el-row :gutter="5" type="flex" class="paddingTop5">
                            <el-col :xs="24" :sm="24">
                                <el-input type="text" ref="nomBuscar"
                                    ...
                                    placeholder="Buscar Grupo Médico" 
...
import AjusteGrupoMedicoService from '@/services/ajustes/prod_grupomedico-service'
...
export default {
    ...
    data() {
        return {
            ...
            nomBuscar:"",
            //-----------------------------------
            tittleModulo:'Productos -  Grupo Médico',
            //-----------------------------------
            IdCliente:-1,
            lobeCliente:[],
            grupomedico:'',
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          AjusteGrupoMedicoService.CargarDatosIniciales(this.usuario.usuarioLogin, this.usuario.idCliente)
            .then(res => {
                if (res.status==200){
        ...
        ValidarGuardar(){
            ...
            if(this.grupomedico==''){
                return 'Debe ingresar Nombre Grupo Médico.';
            }
            return '';
        },
        ...
        GuardarBD(){
            AjusteGrupoMedicoService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjusteGrupoMedicoService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Editar(id, row){
            ...
            //-----------------
            this.Id = row.Id;
            this.grupomedico = row.Nombre;
            this.IdCliente = row.IdCliente;
            this.activo = row.Estado?'SI':'NO';
        },
        Eliminar(id, row){
            this.$confirm('Desea eliminar Grupo Médico seleccionado?', 'Eliminar Grupo Médico', {
                confirmButtonText: 'SI',
                cancelButtonText: 'NO',
                type: 'warning'
            }).then(() => {
                AjusteGrupoMedicoService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
