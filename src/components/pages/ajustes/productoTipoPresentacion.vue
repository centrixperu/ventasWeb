                                ...
                                <el-col :xs="17" :sm="18" :md="20" :lg="19" :xl="20">
                                    <div>
                                        <el-input type="text" id="codigo"
                                            size="small"
                                            ref="tipopresentacion"
                                            @keyup.native="KeyUpNombre"
                                            :autosize="{ minRows: 2, maxRows: 3}" 
                                            placeholder="Nombre Tipo Presentación" 
                                            v-model="tipopresentacion"
                                            show-word-limit
                                            maxlength="150">
                                        </el-input>
                                    </div>
                                ...
                                <el-col :xs="17" :sm="18" :md="20" :lg="19" :xl="20">
                                    <div>
                                        <el-input type="text" id="codigocorto"
                                            size="small"
                                            ref="codpresentacion"
                                            @keyup.native="KeyUpCodigo"
                                            :autosize="{ minRows: 2, maxRows: 3}" 
                                            placeholder="Abreviatura" 
                                            v-model="codpresentacion"
                                            show-word-limit
                                            maxlength="8">
                                        </el-input>
                                    </div>
                        ...
                        <div>
                            <el-table ref="listado" :data="lobeListadoFiltrado" 
                                ...
                                <el-table-column prop="Nombre" 
                                        width="350">
                                    <template slot="header" slot-scope="scope">
                                        <span class="textAdjust textcenter">Tipo Presentación</span>
                                        <span class="caret-wrapper">
                                        ...
                                        <el-input size="mini" class="padding0" 
                                                v-model="tipopresentacionTable"></el-input>
                                    </template>
                                </el-table-column>
                        ...
                        <el-row :gutter="5" type="flex" class="paddingTop5">
                            <el-col :xs="24" :sm="24">
                                <el-input type="text" ref="nomBuscar"
                                    ...
                                    placeholder="Buscar tipopresentacion" 
...
import AjusteTipoPresentacionService from '@/services/ajustes/prod_tipopresentacion-service'
...
export default {
    ...
    data() {
        return {
            ...
            nomBuscar:"",
            //-----------------------------------
            tittleModulo:'Productos -  Tipo Presentación',
            //-----------------------------------
            IdCliente:-1,
            lobeCliente:[],
            tipopresentacion:'',
    ...
    watch: {
        ...
        tipopresentacionTable: function(n){
            this.filtros[2].Valor = n;
            this.Paginar();
        },
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          AjusteTipoPresentacionService.CargarDatosIniciales(this.usuario.usuarioLogin, this.usuario.idCliente)
            .then(res => {
                if (res.status==200){
        ...
        ValidarGuardar(){
            ...
            if(this.tipopresentacion==''){
                return 'Debe ingresar Tipo de Presentación.';
            }
            return '';
        },
        CreaObjetoEnvioBD : function(tipo,id){
            ...
            if (tipo==1){
                item.Id = this.Id;
                item.Nombre = this.tipopresentacion;
                item.Abreviatura = this.codpresentacion;
        ...
        GuardarBD(){
            AjusteTipoPresentacionService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjusteTipoPresentacionService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Editar(id, row){
            ...
            //-----------------
            this.Id = row.Id;
            this.tipopresentacion = row.Nombre;
            this.codpresentacion = row.Abreviatura;
            this.IdCliente = row.IdCliente;
            this.activo = row.Estado?'SI':'NO';
        },
        Eliminar(id, row){
            this.$confirm('Desea eliminar el Tipo de Presentación seleccionado?', 'Eliminar Tipo Presentación', {
                confirmButtonText: 'SI',
                cancelButtonText: 'NO',
                type: 'warning'
            }).then(() => {
                AjusteTipoPresentacionService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
        ...
        KeyUpNombre(){
            this.tipopresentacion = this.tipopresentacion.toUpperCase();
        },
        KeyUpCodigo(){
            this.codpresentacion = this.codpresentacion.toUpperCase();
        },
    }
};
</script>
