                        ...
                        <div>
                            <el-table ref="listado" :data="lobeListadoFiltrado" 
                                ...
                                <el-table-column prop="Nombre" 
                                        width="350">
                                    <template slot="header" slot-scope="scope">
                                        <span class="textAdjust textcenter">Color</span>
                                        <span class="caret-wrapper">
...
import AjusteColorService from '@/services/ajustes/color-service'
...
export default {
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          AjusteColorService.CargarDatosIniciales(this.usuario.usuarioLogin, this.usuario.idCliente)
            .then(res => {
                if (res.status==200){
        ...
        ValidarGuardar(){
            ...
            if(this.color==''){
                return 'Debe ingresar Nombre Color.';
            }
            return '';
        },
        ...
        GuardarBD(){
            AjusteColorService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjusteColorService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Eliminar(id, row){
            this.$confirm('Desea eliminar el Almacén seleccionado?', 'Eliminar Almacén', {
                ...
                AjusteColorService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
