                    ...
                    <div class="cus-container-border margin0 width100">
                        <el-main class="padding5">
                            ...
                            <el-row :gutter="5" type="flex" class="paddingTop10">
                                <el-col :xs="7" :sm="6" :md="4" :lg="3" :xl="1">
                                    <div class="cus-label-form-left">
                                        <span class="cus-label textAdjust textAlignL">Cod. SUNAT:</span>
                                    </div>
                                </el-col>
                                <el-col :xs="17" :sm="18" :md="20" :lg="19" :xl="20">
                                    <div>
                            ...
                            <el-row :gutter="5" type="flex" class="paddingTop10">
                                <el-col :xs="7" :sm="6" :md="4" :lg="3" :xl="1">
                                    <div class="cus-label-form-left">
                                        <span class="cus-label textAdjust textAlignL">Doc. Identidad (x Defecto):</span>
                                    </div>
                                </el-col>
                                <el-col :xs="17" :sm="18" :md="20" :lg="19" :xl="20">
                                    <div>
                                        <el-select v-model="IdDocIden" filterable placeholder="Select"
                                            size="small" ref="IdDocIden" class="width100">
                                            <el-option v-for="oDocIden in lobeTipoDocIden" 
                                                :key="oDocIden.codigo" 
                                                :label="oDocIden.descripcion"
                                                :value="oDocIden.codigo">
                                            </el-option>                            
                                        </el-select>
                                    </div>
                                </el-col>
                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <div>
                            <el-table ref="listado" :data="lobeListadoFiltrado" 
                                ...
                                <el-table-column prop="CodigoSUNAT" 
                                        width="200">
                                    <template slot="header" slot-scope="scope">
                                        <span class="textAdjust textcenter">Cod. SUNAT</span>
                                        <span class="caret-wrapper">
                                        ...
                                        <el-input size="mini" class="padding0" 
                                                v-model="codSUNATTable"></el-input>
                                    </template>
                                </el-table-column>
                                ...
                                <el-table-column prop="DesDocDefecto" 
                                        width="350">
                                    <template slot="header" slot-scope="scope">
                                        <span class="textAdjust textcenter">Doc. x Defecto</span>
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 2?'colorOrderBottom':'']" @click="Ascendente(3)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 2?'colorOrderTop':'']" @click="Descendente(3)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                                                v-model="desdocdefectoTable"></el-input>
                                    </template>
                                </el-table-column>
                                <el-table-column
                                        width="100">
                                    ...
                                    <template slot="header" slot-scope="scope">
                                        ...
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 3?'colorOrderBottom':'']" @click="Ascendente(4)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 3?'colorOrderTop':'']" @click="Descendente(4)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                                ...
                                <el-table-column prop="UsrCreador" 
                                    ...
                                    <template slot="header" slot-scope="scope">
                                        ...
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 4?'colorOrderBottom':'']" @click="Ascendente(5)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 4?'colorOrderTop':'']" @click="Descendente(5)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                                ...
                                <el-table-column prop="FchCreacion" 
                                    ...
                                    <template slot="header" slot-scope="scope">
                                        ...
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 5?'colorOrderBottom':'']" @click="Ascendente(6)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 5?'colorOrderTop':'']" @click="Descendente(6)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                                ...
                                <el-table-column prop="UsrModificador" 
                                    ...
                                    <template slot="header" slot-scope="scope">
                                        ...
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 6?'colorOrderBottom':'']" @click="Ascendente(7)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 6?'colorOrderTop':'']" @click="Descendente(7)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                                ...
                                <el-table-column prop="FchModificacion" 
                                    ...
                                    <template slot="header" slot-scope="scope">
                                        ...
                                        <span class="caret-wrapper">
                                            <i class="sort-caret ascending" v-bind:class="[asc == 7?'colorOrderBottom':'']" @click="Ascendente(8)"></i>
                                            <i class="sort-caret descending" v-bind:class="[desc == 7?'colorOrderTop':'']" @click="Descendente(8)"></i>
                                        </span>
                                        <el-input size="mini" class="padding0" 
                        ...
                        <el-row :gutter="5" type="flex" class="paddingTop5"
                            ...
                            <el-main class="padding5 cus-border">
                                <el-row :gutter="5" type="flex" class="paddingTop0">
                                    <el-col :xs="24" :sm="24">
                                        <div class="cus-label-form-left">
                                            <span class="cus-label textAdjust textAlignL fontbold">{{oListado.Descripcion}}</span>
                                            <el-button-group>
                                                <el-button
                                                    size="mini" icon="el-icon-edit"
                                ...
                                <el-row :gutter="5" type="flex" class="paddingTop5">
                                    <el-col :xs="24" :sm="24">
                                        <div class="cus-label-form-left">
                                            <span class="cus-label textAdjust textAlignL width105P">Cod. SUNAT:</span>
                                            <el-input class="paddingRight10" v-model="oListado.CodigoSUNAT" size="mini" readonly></el-input>
                                            <span class="cus-label textAdjust textAlignL width105P">Doc. x Defecto:</span>
                                            <el-input class="paddingRight10" v-model="oListado.DesDocDefecto" size="mini" readonly></el-input>
                                        </div>
                                    </el-col>
                                </el-row>
                                <el-row :gutter="5" type="flex" class="paddingTop5">
...
import AjusteComprobanteService from '@/services/ajustes/comprobante-service'
...
export default {
    ...
    data() {
        return {
            ...
            filtros:[
                {columna:'Id', Valor:'',},
                {columna:'CodigoSUNAT', Valor:''},
                {columna:'Descripcion', Valor:'',},
                {columna:'DesDocDefecto', Valor:'',},
    ...
    methods: {
        filtrarAscendente(id){
            if(id==0){
                ...
                this.lobeListadoFiltrado = this.lobeListadoFiltrado.sort(function(a, b) {
                    if (a.CodigoSUNAT < b.CodigoSUNAT)
                        return -1;
                    if (a.CodigoSUNAT > b.CodigoSUNAT)
                        return 1;
                    return 0;
                ...
                this.lobeListadoFiltrado = this.lobeListadoFiltrado.sort(function(a, b) {
                    if (a.DesDocDefecto < b.DesDocDefecto)
                        return -1;
                    if (a.DesDocDefecto > b.DesDocDefecto)
                        return 1;
                    return 0;
        ...
        CargarDatosIniciales(){
          AjusteComprobanteService.CargarDatosIniciales(this.usuario.usuarioLogin)//, this.usuario.idCliente)
            .then(res => {
                if (res.status==200){
                    this.lobeListado = res.result.loListado;
                    this.lobeCliente = res.result.loCliente;
                    this.lobeTipoDocIden = res.result.loTipoDocIden;
        ...
        ValidarGuardar(){
            /*if(this.usuario.isAdministrador && this.IdCliente==-1){
                return 'Debe seleccionar Cliente.';
            }*/
            if(this.nombre==''){
                return 'Debe ingresar Nombre Comprobante.';
            }
            if(this.codSunat==''){
                return 'Debe ingresar Cod. SUNAT de Comprobante.';
            }
            return '';
        },
        CreaObjetoEnvioBD : function(tipo,id){
            ...
            if (tipo==1){
                item.Id = this.Id;
                item.CodigoSUNAT = this.codSunat;
                item.Descripcion = this.nombre;
                item.CodDocDefecto = this.IdDocIden;
        ...
        GuardarBD(){
            AjusteComprobanteService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjusteComprobanteService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Editar(id, row){
            ...
            //-----------------
            this.Id = row.Id;
            this.codSunat = row.CodigoSUNAT;
            this.nombre = row.Descripcion;
            this.IdDocIden = row.CodDocDefecto;
            //this.IdCliente = row.IdCliente;
            this.activo = row.Estado?'SI':'NO';
        },
        Eliminar(id, row){
            this.$confirm('Desea eliminar el Conmprobante seleccionado?', 'Eliminar Comprobante', {
                confirmButtonText: 'SI',
                cancelButtonText: 'NO',
                type: 'warning'
            }).then(() => {
                AjusteComprobanteService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
        ...
        Paginar(){
            ...
            this.totalrows=this.lobeListadoFiltrado.filter(function(item){ 
                return ((
                        ...
                        (item.CodigoSUNAT.toString().toUpperCase().indexOf(this.filtros.filter(f => f.columna=='CodigoSUNAT')[0].Valor.toUpperCase()) >= 0) && 
                        (item.Descripcion.toString().toUpperCase().indexOf(this.filtros.filter(f => f.columna=='Descripcion')[0].Valor.toUpperCase()) >= 0) && 
                        (item.DesDocDefecto.toString().toUpperCase().indexOf(this.filtros.filter(f => f.columna=='DesDocDefecto')[0].Valor.toUpperCase()) >= 0) && 
