                        ...
                        <el-row :gutter="5" type="flex" class="paddingTop5"
                            ...
                            <el-main class="padding5 cus-border">
                                <el-row :gutter="5" type="flex" class="paddingTop0">
                                    <el-col :xs="24" :sm="24">
                                        <div class="cus-label-form-left">
                                            <span class="cus-label textAdjust textAlignL fontbold">{{oListado.Tienda}}</span>
                                            <el-button-group>
                                                <el-button
                                                    size="mini" icon="el-icon-edit"
                                ...
                                <el-row :gutter="5" type="flex" class="paddingTop5">
                                    <el-col :xs="24" :sm="24">
                                        <div class="cus-label-form-left">
                                            <span class="cus-label textAdjust textAlignL width95P">Dirección:</span>
                                ...
                                <el-row :gutter="5" type="flex" class="paddingTop5">
                                    <el-col :xs="24" :sm="24">
                                        <div class="cus-label-form-left">
                                            <span class="cus-label textAdjust textAlignL width95P">Urbanización:</span>
...
import AjusteTiendaService from '@/services/ajustes/tienda-service'
...
export default {
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          AjusteTiendaService.CargarDatosIniciales(this.usuario.usuarioLogin, this.usuario.idCliente)
            .then(res => {
                if (res.status==200){
        ...
        ValidarGuardar(){
            if(this.tienda==''){
                return 'Debe ingresar Tienda.';
            }
            if(this.direccion==''){
                return 'Debe ingresar Dirección.';
            }
            if(this.urbanizacion==''){
                return 'Debe ingresar Urbanización.';
            }
        ...
        GuardarBD(){
            AjusteTiendaService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjusteTiendaService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Eliminar(id, row){
            this.$confirm('Desea eliminar la Tienda seleccionada?', 'Eliminar Tienda', {
                confirmButtonText: 'SI',
                cancelButtonText: 'NO',
                type: 'warning'
            }).then(() => {
                AjusteTiendaService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
        ...
        Paginar(){
            ...
            this.totalrows=this.lobeListadoFiltrado.filter(function(item){ 
                return ((
                        ...
                        (item.Tienda.toString().toUpperCase().indexOf(this.filtros.filter(f => f.columna=='Tienda')[0].Valor.toUpperCase()) >= 0) && 
