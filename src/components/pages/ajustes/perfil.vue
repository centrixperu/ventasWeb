...
import AjustePerfilService from '@/services/ajustes/perfil-service'
...
export default {
    ...
    watch: {
        IdCliente: function(n){
            if(this.isEdicionOne){
                this.isEdicionOne = false;
            } else {
                this.CargarDatosCliente(n);
            }
        },
    ...
    methods: {
        ...
        CargarDatosIniciales(){
          AjustePerfilService.CargarDatosIniciales(this.usuario.usuarioLogin, this.IdCliente)
            .then(res => {
                if (res.status==200){
        ...
        CargarDatosCliente(idCliente){
          AjustePerfilService.CargarDatosCliente(this.usuario.usuarioLogin, idCliente)
            .then(res => {
                if (res.status==200){
                    this.lobeModulo = res.result.loModulos;
                    this.lobeModuloSelec = [];
        ...
        ValidarGuardar(){
            ...
            if(this.nombre==''){
                return 'Debe ingresar Nombre Perfil.';
            }
        ...
        GuardarBD(){
            AjustePerfilService.Guardar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        ActualizarBD(){
            AjustePerfilService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Eliminar(id, row){
            this.$confirm('Desea eliminar el Perfil seleccionado?', 'Eliminar Perfil', {
                confirmButtonText: 'SI',
                cancelButtonText: 'NO',
                type: 'warning'
            }).then(() => {
                AjustePerfilService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
