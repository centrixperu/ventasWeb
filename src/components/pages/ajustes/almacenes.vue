...
export default {
    ...
    methods: {
        ...
        ActualizarBD(){
            AjusteAlmacenService.Actualizar(this.CreaObjetoEnvioBD(1,0))
                .then(res => {
                    if (res.status==200){
                        this.CargarDatosIniciales();
                        this.$message({
        ...
        Eliminar(id, row){
            this.$confirm('Desea eliminar el Almacén seleccionado?', 'Eliminar Almacén', {
                ...
                AjusteAlmacenService.Eliminar(this.CreaObjetoEnvioBD(2,id))
                    .then(res => {
                        if (res.status==200){
