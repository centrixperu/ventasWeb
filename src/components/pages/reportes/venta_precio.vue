...
export default {
    ...
    data() {
        return {
            tittleModulo:'Ventas por Precio',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE VENTA POR PRECIO POR DIA";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRECIO POR MES";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRECIO POR AÑO";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRECIO POR RANGO";
            ...
            ReporteClienteService.ReporteVentaPrecio(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
