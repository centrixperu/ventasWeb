...
export default {
    ...
    data() {
        return {
            tittleModulo:'Ventas por Producto',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE VENTA POR PRODUCTO POR DIA";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRODUCTO POR MES";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRODUCTO POR AÑO";
                ...
                this.tittleReporte="REPORTE DE VENTA POR PRODUCTO POR RANGO";
            ...
            ReporteClienteService.ReporteVentaProducto(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
