...
export default {
    ...
    data() {
        return {
            tittleModulo:'Kardex por Precio',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE KARDEX PRECIO POR DIA";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRECIO POR MES";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRECIO POR AÑO";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRECIO POR RANGO";
            ...
            ReporteClienteService.ReporteKardexPrecio(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
