...
export default {
    ...
    data() {
        return {
            tittleModulo:'Kardex por Producto',
            tittleReporte:'',
            //-----------------------------------
            tipoFiltro:'',
            fechaDia:'',
    ...
    methods: {
        ...
        BuscarBD(){
            ...
            let fechafin = "";
            if (this.isDia){
                this.tittleReporte="REPORTE DE KARDEX PRODUCTO POR DIA";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRODUCTO POR MES";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRODUCTO POR AÑO";
                ...
                this.tittleReporte="REPORTE DE KARDEX PRODUCTO POR RANGO";
            ...
            ReporteClienteService.ReporteKardexProducto(this.usuario.usuarioLogin, this.usuario.idCliente, this.isDia,
